...
import { View, Text, StyleSheet, TouchableOpacity, Image, ImageBackground, FlatList, ScrollView} from 'react-native';
import { CircularProgress } from 'react-native-circular-progress';
import Svg, { Circle } from 'react-native-svg';

function MyPage() {
    // 예시 데이터
    const articlesReadThisWeek = 6;
    const totalArticlesGoal = 10;
    const quizScoreThisWeek = 15;
    const totalQuizScoreGoal = 100;
    const name = "김민경"
    ...
    return (
        <View style={styles.container}>
            ...
            <View style= {styles.nameContainer}>
                ...
                <Text style= {styles.name}>in Beginner Mode</Text>
            </View>
            ...
            <View style={styles.progressContainer}>
                <View style={styles.progressContainerStem}>
                    <Svg height="170" width="170" viewBox="0 0 100 100">
                        {/* 배경 원 */}
                        <Circle cx="50" cy="50" r="45" fill="#571b01" fillOpacity={opacity}/>
                    </Svg>
                    <ImageBackground
            ...
            <View style = {styles.progressTextContainer}>
                ...
                <Text style={styles.bonusScoreExplain}>(You can get it if you achive your goals)</Text>
